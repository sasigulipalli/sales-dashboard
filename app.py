...
st.set_page_config(page_title="Sales Dashboard", page_icon="\U0001F4C8", layout="wide"
)
...
fig_product_sales = px.bar(
    ...
    color_discrete_sequence=["#a0db8e"] * len(sales_by_product_line),
...
fig_hourly_sales = px.bar(
    ...
    color_discrete_sequence=["#f6546a"] * len(sales_by_hour),
    template="plotly_white",
)
...
fig_scatter = px.scatter(df_grouped, x="Customer_type", y="Rating", color="Gender", color_discrete_sequence=["#000080", "#F5A623"])
...
middle_column.plotly_chart(fig_payment,  use_container_width=True)
left_column.plotly_chart(fig_scatter,  use_container_width=True)
right_column.plotly_chart(fig_product_sales, use_container_width=True)
middle_column.plotly_chart(fig_product, use_container_width=True)
right_column.plotly_chart(fig, use_container_width=True)
left_column.plotly_chart(fig_rating, use_container_width=True)
middle_column.plotly_chart(fig_trial, use_container_width=True)
